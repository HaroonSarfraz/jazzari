              ...
              <div class="row">
                ...
                <div data-category="seo" class="reference-item col-lg-3 col-md-6">
                  <div class="reference"><a href="#"><img src="img/patientiq.png" alt="" class="img-fluid" />
                    <div class="overlay">
                      <div class="inner">
                        <h3 class="h4 reference-title">PatientIQ</h3>
                        <p>PatientIQ is a platform for healthcare providers, researchers, and others to collaborate on the mission to improve patient outcomes.</p>
                      </div>
                    </div>
                  </a>
                    <div data-images="img/patientiq.png" class="sr-only reference-description">
                      ...
                      <p>PatientIQ's cloud-based platform couples industry leading patient engagement technology with research quality advanced analytics. We do the heavy lifting so you can focus on what matters - improving patient outcomes.</p>
                      <p>The PatientIQ platform is designed to automate clinical workflows, increase patient engagement and systematically measure outcomes on every patient that walks through the door.</p>
                      <p class="buttons text-center"><a href="javascript:void(0);" class="btn btn-outline-primary"><i
                        class="fa fa-globe"></i> Visit website</a><a href="javascript:void(0);"
                          class="btn btn-outline-primary"><i class="fa fa-download"></i> Download case study</a></p>
                    </div>
